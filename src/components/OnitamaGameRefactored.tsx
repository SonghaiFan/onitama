...
interface OnitamaGameRefactoredProps {
  cardPacks?: (
    | "normal"
    | "senseis"
    | "windway"
...
const OnitamaGameRefactored = forwardRef<
  { resetGame: () => void },
  OnitamaGameRefactoredProps
>(function OnitamaGameRefactored(
  { cardPacks = ["normal"], language = "zh" },
  ref
) {
  const {
    gameState,
    ...
    <div className="w-full h-full flex flex-col watercolor-wash z-10 relative">
      ...
      <div className="game-layout-grid flex-1">
        ...
        <Card
          ...
          gridArea={
            gameState.currentPlayer === "blue" ? "shared-left" : "shared-right"
          }
          isSelected={false}
          playerOwner="shared"
          currentPlayer={gameState.currentPlayer}
...
export default OnitamaGameRefactored;
