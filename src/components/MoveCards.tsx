...
const Card = React.memo(({
  ...
  const positionClasses = {
    "red-left": "left-[calc(50%-6rem)] top-[calc(50%+12rem)] sm:left-[calc(50%-7rem)] sm:top-[calc(50%+14rem)] lg:left-[calc(50%-8rem)] lg:top-[calc(50%+16rem)]",
    "red-right": "left-[calc(50%+2rem)] top-[calc(50%+12rem)] sm:left-[calc(50%+3rem)] sm:top-[calc(50%+14rem)] lg:left-[calc(50%+4rem)] lg:top-[calc(50%+16rem)]",
    "blue-left": "left-[calc(50%-6rem)] top-[calc(50%-16rem)] sm:left-[calc(50%-7rem)] sm:top-[calc(50%-18rem)] lg:left-[calc(50%-8rem)] lg:top-[calc(50%-20rem)]",
    "blue-right": "left-[calc(50%+2rem)] top-[calc(50%-16rem)] sm:left-[calc(50%+3rem)] sm:top-[calc(50%-18rem)] lg:left-[calc(50%+4rem)] lg:top-[calc(50%-20rem)]",
    "shared-left": "left-[calc(50%-18rem)] top-[calc(50%-1rem)] sm:left-[calc(50%-22rem)] lg:left-[calc(50%-26rem)]",
    "shared-right": "left-[calc(50%+14rem)] top-[calc(50%-1rem)] sm:left-[calc(50%+18rem)] lg:left-[calc(50%+22rem)]",
  };
  ...
  const canInteract = !isShared && ((isRed && currentPlayer === "red") || (isBlue && currentPlayer === "blue"));
  ...
  return (
    <motion.div
      className={`
        ...
        ${sizeClasses}
        ${positionClasses[position as keyof typeof positionClasses] || "left-1/2 top-1/2"}
        ${isRed ? "border-red-300" : isBlue ? "border-blue-300" : "border-stone-300"}
    ...
    >
      ...
      <div className={`zen-card ${isShared ? "p-2 sm:p-3" : "p-0"} border border-stone-300`}>
            ...
            Array.from({ length: 5 }, (_, j) => {
              ...
              if (actualI === 2 && actualJ === 2) {
                return (
                  ...
                  >
                    <span className="text-[8px] sm:text-[10px] text-stone-100">中</span>
                  </div>
                );
              }
      ...
      {isShared && (
        ...
        >
          下一回合輪到
          <span className={`ml-1 ${card.color === "red" ? "text-red-600" : "text-blue-600"}`}>
...
export default function MoveCards({ cards, currentPlayer, onCardClick }: MoveCardsProps) {
  return (
